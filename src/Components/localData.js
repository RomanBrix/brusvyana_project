const MainTranslate = {
    ua:{
        ...
        MainPage:{
            ...
            info:{
                headLeft: 'Сучасні технології размножения і вирощування саджанців',
                leftParagraph:[
                ...
                headRight: 'Вже понад 16 років якість, сортність та сервіс – наша запорука успіху!',
            },
            infoBlocks: {
                block1: {
            ...
            team:{
                ...
                team:[
                    ...
                    },
                    {
                        ...
                        description:"Контакти: brusvyana@ukr.net +380674113695"
                    },
                    {
                        name:'Король Євген Антонійович',
                        img: '3.jpg',
                        position: 'Директор садового центра Брусвяна',
                        description:"Контакти: brusvyana@ukr.net +380674113692"
                    },
                    {
                        name:'Горова Тетяна Сергіївна',
                        img: '4.jpg',
                        position: 'Менеджер по роботі з оптовими клієнтами',
                        description:"Контакти: brusvyana@ukr.net +380674113691"
                    }
                ]
            }
        },
        ...
        contacts:{
            ...
            address:"Житомирська обл., Брусилівський р-н, с. Костівці, вул. Польова 1"
        }
    },
    ru:{
        header: {
        ...
        MainPage:{
            ...
            info:{
                headLeft: 'Современные технологии размножения и выращивания саженцев',
                leftParagraph:[
                ...
                headRight: 'Уже более 16 лет качество, сортность и сервис – наш залог успеха!',
            },
            infoBlocks: {
                block1: {
            ...
            team:{
                ...
                team:[
                    ...
                    },
                    {
                        ...
                        description:"Контакты: brusvyana@ukr.net +380674113695"
                    },
                    {
                        name:'Король Евгений Антониевич',
                        img: '3.jpg',
                        position: 'Директор садового центра Брусвяна',
                        description:"Контакты: brusvyana@ukr.net +380674113692"
                    },
                    {
                        name:'Горовая Татьяна Сергеевна',
                        img: '4.jpg',
                        position: 'Менеджер по работе с оптовыми клиентами',
                        description:"Контакты: brusvyana@ukr.net +380674113691"
                    }
                ]
            }
        },
        ...
        contacts:{
            ...
            address:"Житомирская область, Брусиловский р-н, с. Костовцы, ул. Полевая 1"
        }
    },
    en:{
        header: {
        ...
        MainPage:{
            ...
            info:{
                headLeft: 'Modern technologies of propagation and growing of seedlings',
                leftParagraph:[
                ...
                headRight: 'For more than 16 years, quality, quality and service have been our key to success!',
            },
            infoBlocks: {
                block1: {
            ...
            team:{
                ...
                team:[
                    ...
                    },
                    {
                        ...
                        description:"Contacts: brusvyana@ukr.net +380674113695"
                    },
                    {
                        name:'King Evgeny Antoniyovych',
                        img: '3.jpg',
                        position: 'Director of Brusvyan garden center',
                        description:"Contacts: brusvyana@ukr.net +380674113692"
                    },
                    {
                        name:'Horova Tetyana Serhiivna',
                        img: '4.jpg',
                        position: 'Manager for work with wholesale customers',
                        description:"Contacts: brusvyana@ukr.net +380674113691"
                    }
                ]
            }
        },
        ...
        contacts:{
            ...
            wholesale:"Wholesale",
            retail:'Retail',
            address:"Zhytomyr region, Brusilovsky district, with. Kostovtsy, st. Field 1"
        }
    }
}
