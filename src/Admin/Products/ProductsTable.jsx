...
export default function AdminProductsTable() {
    ...
    return (
        <div className="all-users whiteBg">
            ...
            {
                newProductLayer && <NewProductLayer setNewProductLayer={setNewProductLayer}/>
            }
            <div className="top">
                <h1>Товари </h1>
                <div className="search">
                    <input type="text" id="search" 
                        ...
                        onChange={({target})=>{ setSearch(target.value); setSearchReq(true); setPage(1); setLastPage(false);}} 
...
function NewProductLayer({setNewProductLayer }){
    ...
    return(
        <div className="import-product-layer" onClick={()=>{setNewProductLayer(false)}}>
    ...
    function renderCatalogs(){
        return catalogs.map((catalog)=>{
            return (
                <div className="catalog_item" key={catalog._id} onClick={()=>{
